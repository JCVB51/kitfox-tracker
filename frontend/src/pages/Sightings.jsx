const exampleSightings = [
  { id: 1, location: 'Near campus field', status: 'Needs review' },
...
function Sightings() {
  return (
    <section>
      <h2>Sightings</h2>
      <p>This page uses placeholder data. A future milestone will connect this view to real stored records.</p>
